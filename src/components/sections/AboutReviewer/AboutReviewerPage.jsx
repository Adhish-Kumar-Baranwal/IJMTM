    ...
    <NavBar />
      ...
      <div className="about-reviewer-page-container">
        ...
        <div className="about-reviewer-section">
          ...
          <p>
            A reviewer plays a crucial role in maintaining the quality of academic
            publications. By evaluating research papers, reviewers ensure that
            only high-quality and original work is published.
          </p>
        </div>
        ...
        <div className="reviewer-duties-section">
          ...
          <ul>
            <li>Critically assess research papers for quality and originality.</li>
        ...
        <div className="reviewer-benefits-section">
          ...
          <ul>
            ...
            <li>Enhance your knowledge and stay updated with research trends.</li>
